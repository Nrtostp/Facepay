...
public class Util {
    ...
    private static String canonicalize(String input, int pos, int limit, String encodeSet,
                                       boolean alreadyEncoded, boolean strict, boolean plusIsSpace, boolean asciiOnly) throws EOFException {
        int codePoint;
    ...
    static String canonicalize(String input, String encodeSet, boolean alreadyEncoded, boolean strict) throws EOFException {
        return canonicalize(
